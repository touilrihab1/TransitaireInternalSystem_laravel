            ...
            <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group" style="position:relative;">
                                    <input type="text" class="form-control" value="{{$dum->bureau_dedouanement}}" id="Bureau_d" name="bureau_dedouanement"
                                        wire:model="search" wire:keyup="searchResult" disabled>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" value="{{$dum->arrondissement}}" id="Arrond" name="arrondissement"
                                        wire:model="search_arrondissement" wire:keyup="searchResult1" disabled>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" value="{{$dum->bureau_destination}}" id="Bureau_destination"
                                        name="bureau_destination" wire:model="search_dest" wire:keyup="searchDest" disabled>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" value="{{$dum->regime}}" id="Regime" name="regime"
                                        wire:model="search_regime" wire:keyup="searchRegime" disabled>
                    ...
                    <div class="form-row container mr-4">
                        <div class="form-group col ">
                            ...
                            <input type="text" class="form-control" value="{{$dum->n_serie}}" id="N_serie" name="n_serie" wire:model="serie"
                                wire:change="updateNumDum" disabled>
                        </div>
                        <div class="form-group col ">
                        ...
                        <div class="form-group col ">
                            ...
                            <input type="text" class="form-control" value="{{$dum->repertoire}}" id="Repertoire" name="repertoire" disabled>
                        </div>
                    ...
                    <div class="form-row container">
                        <div class="form-group col-md ">
                            ...
                            <input type="date" class="form-control" value="{{$dum->date_debut}}" name="date_debut" disabled>
                        </div>
                        <div class="form-group col-md ">
                            <label for="Date_fin" class="form-label">Date Fin:</label>
                            <input type="date" class="form-control" value="{{$dum->date_fin}}" name="date_fin" disabled>
                        </div>
        
                        <div class="form-group col-md">
                            <label for="Declaration" class="form-label">Declaration:</label>
                            <div class="input-group">
                      <input type="text" class="form-control" value="{{$dum->declaration}}" disabled>
                            </div>
                        </div>
                        <div class="form-group col-md">
                            <label for="Devise" class="form-label">Devise:</label>
                            <input class="form-control" value="{{$dum->devise}}" wire:model="selectedDevise" name="devise" disabled>
                        ...
                        <div class="form-group col-md">
                            ...
                            <input type="text" class="form-control" id="Cours" wire:model="cours" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-row container">
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-group">
                                <input type="text" id="Raison_sociale" name="Raison_sociale" class="form-control"
                                    value="{{$client->Raison_Sociale}}" disabled>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" id="Code_client" name="Code_Tiers" class="form-control" value="{{$client->Code_Tiers}}" disabled>
                        </div>
        
                        <div class="form-group col-md-3">
                            <label for="Adresse" class="form-label">Adresse:</label>
                            <input type="text" id="Adresse" name="Adresse" class="form-control" value="{{$client->Adresse}}" disabled>
                        </div>
                        <div class="form-group col-md-3">
                            <label for="Ville" class="form-label">Ville:</label>
                            <input type="text" id="Ville" name="Ville" class="form-control" value="{{$client->Ville}}" disabled>
                        </div>
                    ...
                    <div class="form-row container justify-content-center mr-4 " style="margin-bottom: 2% ">
                        ...
                        <form action="{{ url('/update/dum') }}" method="POST">
                            @csrf
                            <input type="hidden"  name="dum" value="{{Crypt::encrypt($dum->id)}}" >
